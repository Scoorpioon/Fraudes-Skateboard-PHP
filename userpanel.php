<?php
    ...
    if(!isset($_SESSION['email']) || !isset($_SESSION['senha'])) {
        ...
        $query = $connection -> query('select nome, email, cpf, cep, senha from usuarios where email = "'.$email.'" and senha = md5("'.$senha.'")');
        ...
        <div class="conteudo-do-rodape">
            <section class="canto-esquerdo-rodape">
                <ul class="redes-sociais">
                    ...
                    <li><a href="https://www.instagram.com/_alef.mz/" target="_blank"><i class="fa-brands fa-instagram"></i> Instagram</a></li>
