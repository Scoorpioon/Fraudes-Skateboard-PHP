        ...
        <section id="shapes-a-venda">
            <div class="linha">
                <div class="caixa-de-venda">
                    <img src="imagens/lixa 1.jpeg" alt="Lixa Jessup Hentai">
                    <article>
                ...
                <div class="caixa-de-venda">
                    <img src="imagens/lixa 3.jpeg" alt="Lixa Jessup com um arte de um Personagem Aleatorio">
                    <article>
                        <div class="article-text">
                ...
                <div class="caixa-de-venda">
                    <img src="imagens/lixa 6.jpeg" alt="Lixa Jessup Folhas de Maconha">
                    <article>
                        <div class="article-text">
                            <h3>Lixas Jessup</h3>
                            <p>R&#36; 59,99</p>
            ...
            <div class="linha">
                <div class="caixa-de-venda">
                    <img src="imagens/lixa 4.jpeg" alt="Lixa Jessup com as três fases do Naruto, Criança, Adolescente e Adulto">
                    <article>
                        <div class="article-text">
                ...
                <div class="caixa-de-venda">
                    <img src="imagens/lixa 5.jpeg" alt="Lixa Jessup Com Camuflagem do Exercito">
                    <article>
                        <div class="article-text">
                            <h3>Lixas Jessup</h3>
                            <p>R&#36; 68,99</p>
                ...
                <div class="caixa-de-venda">
                    <img src="imagens/lixa 2.jpeg" alt="Lixa Jessup com várias Imagens Aleatorias como caveiras, simbolo e nome da bones">
                    <article>
                        <div class="article-text">
                            <h3>Lixas Jessup</h3>
                            <p>R&#36; 59,99</p>
